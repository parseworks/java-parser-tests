...
3.  **Implement the interface**: Create a class that implements `io.github.parsercompare.CsvParser`.
4.  **Register as a Service**: Create a file `src/main/resources/META-INF/services/io.github.parsercompare.CsvParser` in your module, and put the full name of your implementation class there.
